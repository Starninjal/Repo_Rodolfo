...
namespace MinhaAgenda
{
    public static class MauiProgram
    {
        public static MauiApp CreateMauiApp()
        {
            ...
            builder.Services.AddSingleton<IRepositorioDeFuncionarios, RepositorioFuncionarioSqlLite>();
            ...
            builder.Services.AddSingleton<IAdicionarFuncionarioUseCase, AdicionarFuncionarioUseCase>();
            ...
            builder.Services.AddSingleton<AdicionarFuncionarioPage>();
